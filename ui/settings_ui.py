...
from PySide6.QtWidgets import QFrame, QHBoxLayout, QPushButton, QSizePolicy, QSpacerItem, QStackedWidget, QVBoxLayout, QWidget, QButtonGroup
...
class Ui_SettingsPage(object):
    def setupUi(self, SettingsPage):
        ...
        self.back_Button_2 = QPushButton(self.settings_frame)
...
"}")
        ...
        self.setting_Button = QPushButton(self.settings_frame)
        ...
        self.pushButton_3 = QPushButton(self.settings_frame)
...
"}")
        ...
        self.pushButton_4 = QPushButton(self.settings_frame)
...
"}")
        ...
        self.verticalLayout_8.addWidget(self.pushButton_2, 0, Qt.AlignmentFlag.AlignLeft)
        ...
        self.verticalLayout_8.addWidget(self.pushButton_9, 0, Qt.AlignmentFlag.AlignLeft)
        ...
        self.verticalLayout_8.addWidget(self.pushButton_8, 0, Qt.AlignmentFlag.AlignLeft)
        self.login_Button = QPushButton(self.frame)
        self.login_Button.setObjectName(u"login_Button")
        self.login_Button.setFont(font4)
        self.login_Button.setStyleSheet(u"")
        self.verticalLayout_8.addWidget(self.login_Button, 0, Qt.AlignmentFlag.AlignLeft)
        self.collection_Button = QPushButton(self.frame)
        self.collection_Button.setObjectName(u"collection_Button")
        self.collection_Button.setFont(font4)
        self.collection_Button.setStyleSheet(u"")
        self.verticalLayout_8.addWidget(self.collection_Button, 0, Qt.AlignmentFlag.AlignLeft)
    ...
    def retranslateUi(self, SettingsPage):
        ...
        self.pushButton.setText(QCoreApplication.translate("SettingsPage", u"Bangumi \u767b\u5f55", None))

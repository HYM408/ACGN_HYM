...
BangumiOAuth::BangumiOAuth(QObject *parent) : QObject(parent), server(nullptr)
{   // 获取信息
...
QString BangumiOAuth::generateAuthUrl() const
{   // 获取授权code
    QString baseUrl = "https://bgm.tv/oauth/authorize";
    QUrlQuery params;
...
QString BangumiOAuth::listenForCode(int timeout)
{   // 获取code
    QUrl redirectUrl(redirectUri);
    QString hostname = redirectUrl.host();
    int port = redirectUrl.port();
    ...
    connect(server, &QTcpServer::newConnection, this, [this]() {
        ...
        connect(socket, &QTcpSocket::readyRead, this, [this, socket]() {
            ...
            QUrlQuery query(QUrl("http://localhost" + path));
...
{   // 换取token
    QString tokenUrl = "https://bgm.tv/oauth/access_token";
    ...
    if (reply->error() == QNetworkReply::NoError) {
        ...
        int expiresIn = tokenData["expires_in"].toInt(604800);
